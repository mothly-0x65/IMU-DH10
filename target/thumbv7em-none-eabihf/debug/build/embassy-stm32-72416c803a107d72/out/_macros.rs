...
macro_rules! foreach_interrupt {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_interrupt_inner!((CRYP,cryp,CRYP,GLOBAL,CRYP));
        ...
        __foreach_interrupt_inner!((HASH,hash,HASH,GLOBAL,HASH_RNG));
...
macro_rules! foreach_peripheral {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_peripheral_inner!((cryp,CRYP));
        ...
        __foreach_peripheral_inner!((hash,HASH));
